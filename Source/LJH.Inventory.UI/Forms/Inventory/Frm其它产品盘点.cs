...
{
    public partial class Frm其它产品盘点 : Form
    {
        public Frm其它产品盘点()
        {
            InitializeComponent();
        ...
        private void FrmInvnetoryCheck_Load(object sender, EventArgs e)
        {
            ...
            btnOk.Enabled = ProductInventory.State == ProductInventoryState.Inventory && Operator.Current.Permit(Permission.其它产品, PermissionActions.Check);
        }
