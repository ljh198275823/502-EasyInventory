...
namespace LJH.Inventory.UI.Forms.Financial.View
{
    public partial class Frm公账已付金额明细 : Form
    {
        ...
        private void mnu_Assign_Click(object sender, EventArgs e)
        {
            ...
            {
                AccountRecord ar = GridView.SelectedRows[0].Tag as AccountRecord;
        ...
        private void GridView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                ...
                AccountRecord ar = GridView.Rows[e.RowIndex].Tag as AccountRecord;
                if (this.GridView.Columns[e.ColumnIndex].Name == "colSheetID")
                {
                    ...
                    if (sheet != null)
                    {
                        ...
                        else if (sheet.ClassID == CustomerPaymentType.客户收款)
                        {
                ...
                else if (this.GridView.Columns[e.ColumnIndex].Name == "colStackSheetID")
                {
