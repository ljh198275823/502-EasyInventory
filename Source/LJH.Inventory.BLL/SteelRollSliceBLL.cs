...
namespace LJH.Inventory.BLL
{
    public class SteelRollSliceBLL:ProductInventoryItemBLL 
    {
        ...
        public CommandResult Depart(ProductInventoryItem info, WareHouse w, string customer, decimal count, string specification, string memo)
        {
            ...
            Product p = new ProductBLL(AppSettings.Current.ConnStr).Create(info.Product.Name, info.Product.CategoryID, specification, info.Product.Model, info.Product.Weight, info.Product.Length);
