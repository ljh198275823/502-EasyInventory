...
namespace LJH.Inventory.UI.Forms
{
    public partial class FrmCurrencyTypeDetail : FrmDetailBase
    {
        ...
        {
            return (new CurrencyTypeBLL(AppSettings.CurrentSetting.ConnectString)).Add(addingItem as CurrencyType);
        }

        protected override CommandResult UpdateItem(object updatingItem)
        {
            return (new CurrencyTypeBLL(AppSettings.CurrentSetting.ConnectString)).Update(updatingItem as CurrencyType);
        }
        #endregion
    }
}
