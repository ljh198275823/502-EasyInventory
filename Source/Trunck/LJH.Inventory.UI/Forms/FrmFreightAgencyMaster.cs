...
{
    public partial class FrmFreightAgencyMaster : FrmMasterBase
    {
        public FrmFreightAgencyMaster()
        {
            InitializeComponent();
        }
        ...
        protected override List<object> GetDataSource()
        {
            ...
            {
                return (from item in items where item.CodeNum ==1 select (object)item).ToList();
            }
            return null;
        }
