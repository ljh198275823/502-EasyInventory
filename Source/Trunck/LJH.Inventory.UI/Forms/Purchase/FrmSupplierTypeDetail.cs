...
namespace LJH.Inventory.UI.Forms
{
    public partial class FrmSupplierTypeDetail : FrmDetailBase
    {
        ...
        public override void ShowOperatorRights()
        {
            ...
            btnOk.Enabled = Operator.Current.Permit(Permission.SupplierType, PermissionActions.Edit);
        }
        ...
        protected override bool CheckInput()
        {
            ...
            if (ParentCategory != null && UpdatingItem != null && (UpdatingItem as SupplierType).ID == ParentCategory.ID)
            {
                MessageBox.Show("供应商类别的父类别不能是本身");
                return false;
            }
            return true;
        }
