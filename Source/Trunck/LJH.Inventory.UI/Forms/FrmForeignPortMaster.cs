...
namespace LJH.Inventory.UI.Forms
{
    public partial class FrmForeignPortMaster :FrmMasterBase 
    {
        ...
        {
            List<Port> items = (new PortBLL(AppSettings.CurrentSetting.ConnectString)).GetForeignPorts();
            if (items != null)
            {
        ...
        {
            CommandResult ret = (new PortBLL(AppSettings.CurrentSetting.ConnectString)).Delete(item as Port);
