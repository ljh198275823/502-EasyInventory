...
{
    public class SupplierReceivableProvider : ProviderBase<SupplierReceivable, Guid>
    {
        #region 构造函数
        public SupplierReceivableProvider(string connStr, System.Data.Linq.Mapping.MappingSource ms)
            : base(connStr,ms)
        {
        }
        #endregion
